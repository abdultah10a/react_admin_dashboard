  ...
  return (
    <div className='mt-12'>
        ...
        justify-center gap-1 items-center'>
          {earningData.map((item) =>(
            <div 
              ...
              className="bg-white
              daark:text-gray-200
              drk:bg-secondary-dark-bg md:w-56
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        ...
        dark:bg-secondary-dark-bg m-3 p-4 md:w-780
        rounded-2xl">
          <div className='flex gap-10 justify-center'>
            <p className='text-xl font-semibold'>Revenue Updates</p>
            <div className='flex gap-4 items-1 center'>
              <p className='flex gap-2 items-center dark:text-gray-600 hover:drop-shadow-xl'>
